...
#ifndef PRUEBAITUNES_SWIFT_H
#define PRUEBAITUNES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PruebaItunes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PruebaItunes9AlbumCell")
...
SWIFT_CLASS("_TtC12PruebaItunes11AppDelegate")
...
SWIFT_CLASS("_TtC12PruebaItunes10ArtistCell")
...
SWIFT_CLASS("_TtC12PruebaItunes26ArtistDetailViewController")
...
SWIFT_CLASS("_TtC12PruebaItunes24ArtistListViewController")
...
@interface ArtistListViewController (SWIFT_EXTENSION(PruebaItunes)) <UISearchBarDelegate>
...
@interface ArtistListViewController (SWIFT_EXTENSION(PruebaItunes)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC12PruebaItunes26CustomCollectionViewLayout")
...
SWIFT_CLASS("_TtC12PruebaItunes13SceneDelegate")
